package com.test.designPattern.behaviour.observerDP.weatherStationPull;

import com.test.designPattern.behaviour.observerDP.weatherStationPull.observable.WeatherObservable;
import com.test.designPattern.behaviour.observerDP.weatherStationPull.observable.WeatherStation;
import com.test.designPattern.behaviour.observerDP.weatherStationPull.observer.CurrentConditionsDisplay;
import com.test.designPattern.behaviour.observerDP.weatherStationPull.observer.ForcastDisplay;
