 ...
 * re-throw exception even after handling exception
 */
...
class Gamma1{
    public  void gamma() throws ArithmeticException{
        try{
            ...
            throw e; // throw exception explicitly
            //exception object will be propagated to main method as well.
            //System.out.println("Catch of Gamma"); //unreachable statement
            //I ncase of the throw, make sure to write throws, so that caller developer of gama would know that there is
            // an exception we have tp handle
        }
